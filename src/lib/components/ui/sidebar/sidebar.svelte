...
{:else}
	...
	>
		...
		<div
			...
			class={cn(
				"fixed inset-y-0 z-10 hidden h-screen w-(--sidebar-width) transition-[transform,width] duration-200 ease-linear md:flex",
				side === "left"
					? "start-0 group-data-[collapsible=offcanvas]:-translate-x-full"
					: "end-0 group-data-[collapsible=offcanvas]:translate-x-full",
